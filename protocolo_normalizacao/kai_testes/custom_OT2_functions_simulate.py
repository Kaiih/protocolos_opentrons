...
protocol = ProtocolContext(simulating=True)
...
opentrons_functions_runDelay = 0
...
def aspirateVolume(pipette, plate, vialLocation, vialName, vialVolume, volume_uL):
    ...
    protocol.delay(seconds=opentrons_functions_runDelay)
    #opentrons_movePipette_toVial(pipette, plate, vialLocation)
    protocol.delay(seconds=opentrons_functions_runDelay)
    #pipette.air_gap(20)
    #protocol.delay(seconds=opentrons_functions_runDelay)
    #opentrons_movePipette_aboveVial(pipette, plate, vialLocation)
    #print("    Done!\n")
    protocol.delay(seconds=opentrons_functions_runDelay)
